...
**Minimal** — just the elapsed time, shown beside another app's Live Activity (a Clock timer here).
...
1. Enter a **session name**, pick a **goal** (30s / 5m / 25m / 50m), and tap **Start New Session**
